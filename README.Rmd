...
Select "Install package internal" from the pkginstaller Addin menu. A pop-up will open where should specify the name of the package to install. Check the directory shown is the correct location of the R packages. If it's not see next section. 
